...
@tag
Feature: Pause the system feature
  This will test the pausing of the system in the local office dashboard
  ...
  @tag2
  Scenario: Pause the system scenario
  	And I then click on Admin tasks
  	And I then click on Manage Hub State
  	And I then click on John Jenkins
  	And I then select Pause Hub
  	And I then select an End Time
  	And I then check pause status on the dashboard
