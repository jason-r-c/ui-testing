...
Feature: Manage an order 
  ...
  Scenario: Select Manage Anthropos Orders
    Given I select Manage Anthropos Orders from the drop down list in the sidebar appflow for All Available Tasks
    And I click Run Task in the All Available Tasks appflow
    
	Scenario: Open order
		Given I select John Ferrari from the Order to Manage drop down list
		And I click next in the Open Orders appflow
		
	Scenario: Client Config
		Given I select Client Configuration from the Option drop down list
		And I click next in the Client Configuration appflow
		
	Scenario: Finish
		Given I click next in the Standard Scenarios appflow
		
	Scenario: Hub outage
		Given I click next in the Hub Outage appflow
