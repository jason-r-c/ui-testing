...
Feature: Create Local Office Actionable Insight
  Create Local Office Actionable Insight for the Local Office dashboard
	...
	Scenario: Login to the Head Office to start Service Status card content creation process
		...
		And I click next
		And I select Office Dashboard from the Alerts during office hours drop down list
		And I select Office Dashboard from the Alerts out of office hours drop down list
		And I select Office Dashboard from the Actionable Insights drop down list
		And I click next
